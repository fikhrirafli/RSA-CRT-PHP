...
<meta charset="utf-8" />
    ...
    <title>Ard Pro | Data Enkripsi</title>
        ...
        <div class="d-flex flex-row" style="height: 650px;">
            ...
            <div class="d-flex flex-column flex-shrink-0 py-3 text-white bg-primary radius mt-5" style="width: 250px;">
                <div class="d-flex flex-column flex-shrink-0 p-3 fluid">
                    ...
                    <img src="../LOGO ARD.png" class="img-fluid" width="120px" ><use xlink:href="#bootstrap"/></img>
                    </a>
                </div>
                <ul class="nav nav-pills  flex-column mb-3 mt-3 ">
                    <li class="nav-item ">
                        <a class="nav-link bg-primary active py-3 rounded-pill fs-5 sidebar "  aria-current="page" href="forminvoice.php"  >
                            <svg class="bi pe-none me-2" width="25" height="25" fill="currentColor"><use xlink:href="#icon-invoice"/></svg>
                            DATA INVOICE
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link bg-warning active py-3 rounded-pill fs-5 sidebar"  aria-current="page" href="formenkripsi.php" >
                            <svg class="bi pe-none me-2" width="25" height="25" fill="currentColor"><use xlink:href="#icon-enkripsi"/></svg>
                            DATA ENKRIPSI
                        </a>
                    </li>
                    <li class="nav-item px-3"><hr></li>
                    <li class="nav-item ">
                        <a class="nav-link bg-primary active py-3 rounded-pill fs-5 sidebar"  aria-current="page" href="#" >
                            <svg class="bi pe-none me-2" width="25" height="25" fill="currentColor"><use xlink:href="#icon-admin"/></svg>
                    ...
                    <li class="nav-item ">
                        <a class="nav-link bg-primary active py-3 rounded-pill fs-5 sidebar"  aria-current="page" href="logout.php" >
                            <svg class="bi pe-none me-2" width="25" height="25" fill="currentColor"><use xlink:href="#icon-logout"/></svg>
                            LOGOUT
                        </a>
                    </li>
                </ul>
            ...
            <div class="d-flex flex-column flex-shrink-0 py-3 flex-grow-1 colorwhite radius mt-5" >
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-3 px-md-4 ">
                    <h1 class="h2 text-secondary">Data Enkripsi Invoice</h1>
                ...
                <div class="py-3 px-md-4" >                   
                    <table class="table table-borderless table-hover" id="invoice">
                        ...
                        <?php
                            $query = "SELECT * FROM dataenkripsi";
                                ...
                                while ($row = (mysqli_fetch_array($hasil))){ 
                                    echo "
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$row[2]</td>
                                                    <td>
                                                        <a href='hapus.php?enknofaktur=$row[0]'>
                                                            <button class='btn btn-primary btn-sm' type='button'>Hapus</button>
                                                        </a>
                                                        <a href='formdekripsi.php?enknofaktur=$row[0]'  target='_blank'>
                                                            <button class='btn btn-outline-primary btn-sm' type='button'>Link Dekripsi</button>
                                                        </a>
                                                        </td>
                                                </tr>
